...
**[Veterinary Clinic Database]** is a project that relational postgreSQL database to create the initial data structure for a veterinary clinic. Tables are created to store animals' information, insert some data into it, and query it.
...
cd my-folder
git clone https://github.com/Theodoraldo/vet-clinic-db.git
...
<p align="right">(<a href="#readme-top" name="readme-top">back to top</a>)</p>
